      ...
      <?php echo the_post_thumbnail_caption(  ); ?>></img>
        <?php endif; ?>
          <div class="card-body">
            ...
            <h6 class="card-subtitle post-card-tag my-2 text-muted"><?php the_date( ); ?></h6>
            <h6 class="card-subtitle post-card-tag my-2 text-muted"><?php the_category( '&nbsp::&nbsp'); ?></h6>
            ...
            <?php edit_post_link( 'edit post','','',null,'card-link edit-post pull-right' ); ?>
          </div>
  </article>
</div>